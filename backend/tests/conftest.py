...
os.environ.setdefault("APNS_KEY_ID", "APNSKEY123")
os.environ.setdefault("APNS_PRIVATE_KEY_B64", _b64(_apple_key).decode())
os.environ.setdefault("APNS_ENVIRONMENT", "sandbox")
