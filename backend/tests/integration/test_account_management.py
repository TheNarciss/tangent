...
async def test_change_password_success(client):
    ...
    await client.post("/api/auth/register", json={"email": email, "password": old_pwd})
    await client.post("/api/auth/login", data={"username": email, "password": old_pwd})
    ...
    login = await client.post("/api/auth/login", data={"username": email, "password": new_pwd})
...
async def test_delete_account_happy_path(client):
    ...
    login = await client.post("/api/auth/login", data={"username": email, "password": pwd})
